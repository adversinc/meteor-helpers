...
Template.registerHelper('formatDateTime', function (date, format) {
    ...
    return (0, dayjs_1.default)(date).format(formatString);
});
/**
...
Template.registerHelper('formatDateTimeSLT', function (date, format) {
    ...
    return secondlife_tools_1.default.timeToSLT(date).format(formatString);
});
/**
...
Template.registerHelper('period2str', function (date) {
    return (0, dayjs_1.default)().to((0, dayjs_1.default)(date), true);
});
