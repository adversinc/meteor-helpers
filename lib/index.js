...
const secondlife_tools_1 = __importDefault(require("@advers/secondlife-tools"));
const relativeTime_1 = __importDefault(require("dayjs/plugin/relativeTime"));
moment_SLT_1.default.extend(relativeTime_1.default);
...
Template.registerHelper('formatDateTime', function (date, format) {
    ...
    return (0, moment_SLT_1.default)(date).format(formatString);
});
/**
...
Template.registerHelper('formatDateTimeSLT', function (date, format) {
    ...
    return moment_SLT_1.default.tz(date, "America/Los_Angeles").format(formatString);
});
/**
...
Template.registerHelper('slname2str', function (slname) {
    ...
    return secondlife_tools_1.default.slname2str(slname);
});
...
Template.registerHelper('period2str', function (date) {
    return (0, moment_SLT_1.default)().to((0, moment_SLT_1.default)(date), true);
});
Template.registerHelper('slname2snake', function (slname) {
    ...
    return secondlife_tools_1.default.slname2str(slname).toLowerCase().replace(" ", "_");
});
/**
